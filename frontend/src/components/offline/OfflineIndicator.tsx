...
export default function OfflineIndicator() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 bg-status-critical text-text-primary px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 ">
      ...
      <div>
        ...
        <p className="text-xs text-status-critical">Changes are saved locally and will sync when reconnected.</p>
      </div>
    </div>
  );
}
